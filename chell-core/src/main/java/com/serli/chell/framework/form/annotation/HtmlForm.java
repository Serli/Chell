...
import com.serli.chell.framework.form.annotation.HtmlForm.FormConstants;
import com.serli.chell.framework.form.render.DivFormRenderer;
...
@Documented
@Inherited
@AnnotationConstants(FormConstants.class)
public @interface HtmlForm {
    ...
    String cssClass() default Constant.HTML_CSS_FORM_CLASS;

    @AnnotationMetaData(Type.HTML_ID)
    String id() default Constant.EMPTY;

    @AnnotationMetaData(Type.FORM_REQUIRED_TEXT)
    String requiredHtml() default Constant.HTML_REQUIRED;

    @AnnotationMetaData(Type.FORM_SEPARATOR_TEXT)
    String separatorHtml() default Constant.HTML_FIELD_SEPARATOR;
    
    @AnnotationMetaData(Type.FORM_RENDERER)
    Class<? extends FormRenderer> renderer() default DivFormRenderer.class;
    
    public static class FormConstants implements AnnotationDefaultValues {
        public DefaultValue[] getDefaultValues() {
            return new DefaultValue[] {
                new DefaultValue(Type.FORM_TYPE, FormType.FORM)
            };
        }        
    }
}
