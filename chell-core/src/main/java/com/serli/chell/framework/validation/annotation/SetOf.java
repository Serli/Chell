...
import com.serli.chell.framework.validation.check.SetOfCheck;
...
@Documented
@Inherited
@FormFieldMetadata(constraint = SetOfCheck.class)
public @interface SetOf {

    @AnnotationMetaData(Type.MESSAGE_KEY)
    String key() default MessageKey.VALIDATION_SET_OF;
