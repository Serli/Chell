...
@Documented
@Inherited
@FormInputMetadata(type = FormType.TEXTAREA)
public @interface HtmlInputTextArea {
    ...
    @AnnotationMetaData(Type.HTML_ROWS)
    int rows() default Constant.UNSPECIFIED;

    @AnnotationMetaData(Type.HTML_COLS)
    int cols() default Constant.UNSPECIFIED;
